...
export const AwardBadge = ({ link, customTitle, customSubtitle, place }: AwardBadgeProps) => {
  ...
  const leaveTimeout1 = useRef<number | null>(null);
  const leaveTimeout2 = useRef<number | null>(null);
  const leaveTimeout3 = useRef<number | null>(null);
  ...
  return (
    ...
    >
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="h-auto w-180px sm:w-260px">
          <defs>
            <filter id="blur1">
