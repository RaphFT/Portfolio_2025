...
export const servicesData: ServiceItem[] = [
  {
    ...
    icon: <SwatchIcon className="w-8 h-8 stroke-1 text-gray-600" />,
    delay: 0,
    colSpan: 2
  },
  {
    ...
    icon: <MagnifyingGlassIcon className="w-8 h-8 stroke-1 text-gray-600" />,
    delay: 0.2
  },
  {
    id: 'web-development',
    ...
    icon: <ComputerDesktopIcon className="w-8 h-8 stroke-1 text-gray-600" />,
    delay: 0.4
  },
  {
    id: 'custom-projects',
    ...
    icon: <WrenchScrewdriverIcon className="w-8 h-8 stroke-1 text-gray-600" />,
    delay: 0.6,
    colSpan: 2
  }
]; 