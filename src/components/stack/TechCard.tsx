    ...
    >
      ...
      <div className="relative flex flex-col space-y-4 sm:space-y-3">
        <div className="flex items-center justify-between">
          <div className="w-8 h-8 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center bg-black/5 group-hover:bg-gradient-to-br group-hover:from-[#47D649] group-hover:to-[#2D5A2E] transition-all duration-300">
            <span className="text-lg sm:text-lg group-hover:text-white transition-colors duration-300">{tech.icon}</span>
          </div>
          <span className="text-xs font-medium px-1 sm:px-2 py-1 rounded-lg backdrop-blur-sm bg-black/5 text-gray-600 transition-colors duration-300 group-hover:bg-[#47D649] group-hover:text-white">
            {tech.category}
          </span>
        </div>
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          >
            <GlitchText glitchInterval={15000} intensity={0.3} glitchDuration={150}>
              {tech.name}
            </GlitchText>
          </h3>
